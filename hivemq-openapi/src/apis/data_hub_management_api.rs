...
/// struct for typed errors of method [`start_trial_mode`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StartTrialModeError {
...
pub async fn start_trial_mode(configuration: &configuration::Configuration) -> Result<(), Error<StartTrialModeError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/data-hub/management/start-trial", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StartTrialModeError> = serde_json::from_str(&local_var_content).ok();
