...
pub struct DiagnosticArchive {
    ...
    #[serde(rename = "failReason", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
