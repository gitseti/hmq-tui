...
pub struct ClientDetails {
    ...
    #[serde(rename = "connectedAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub connection: Option<Option<Box<crate::models::ConnectionDetails>>>,
    /// The MQTT client identifier
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// The current message queue size for this client
    #[serde(rename = "messageQueueSize", skip_serializing_if = "Option::is_none")]
    pub message_queue_size: Option<i64>,
    #[serde(rename = "restrictions", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub restrictions: Option<Option<Box<crate::models::ClientRestrictions>>>,
    /// The session expiry interval
    #[serde(rename = "sessionExpiryInterval", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub session_expiry_interval: Option<Option<i64>>,
    /// If a will is present for this client
    #[serde(rename = "willPresent", skip_serializing_if = "Option::is_none")]
    pub will_present: Option<bool>,
}
