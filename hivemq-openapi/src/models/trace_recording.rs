...
/// TraceRecording : Trace recording item describing the desired (and optionally, when receiving from the server: current) state of a trace recording
...
pub struct TraceRecording {
    ...
    #[serde(rename = "clientIdFilters", skip_serializing_if = "Option::is_none")]
    pub client_id_filters: Option<Vec<crate::models::TraceFilter>>,
    ...
    #[serde(rename = "topicFilters", skip_serializing_if = "Option::is_none")]
    pub topic_filters: Option<Vec<crate::models::TraceFilter>>,
}
...
impl TraceRecording {
    ...
    pub fn new() -> TraceRecording {
        TraceRecording {
            client_id_filters: None,
            end_at: None,
            events: None,
            name: None,
            start_at: None,
...
pub enum Events {
    #[serde(rename = "MQTT_MESSAGE_CONNECT")]
    Connect,
    #[serde(rename = "MQTT_MESSAGE_CONNACK")]
    Connack,
    #[serde(rename = "MQTT_MESSAGE_SUBSCRIBE")]
    Subscribe,
    #[serde(rename = "MQTT_MESSAGE_SUBACK")]
    Suback,
    #[serde(rename = "MQTT_MESSAGE_PUBLISH")]
    Publish,
    #[serde(rename = "MQTT_MESSAGE_PUBACK")]
    Puback,
    #[serde(rename = "MQTT_MESSAGE_PUBREC")]
    Pubrec,
    #[serde(rename = "MQTT_MESSAGE_PUBREL")]
    Pubrel,
    #[serde(rename = "MQTT_MESSAGE_PUBCOMP")]
    Pubcomp,
    #[serde(rename = "MQTT_MESSAGE_UNSUBSCRIBE")]
    Unsubscribe,
    #[serde(rename = "MQTT_MESSAGE_UNSUBACK")]
    Unsuback,
    #[serde(rename = "MQTT_MESSAGE_PINGREQ")]
    Pingreq,
    #[serde(rename = "MQTT_MESSAGE_PINGRESP")]
    Pingresp,
    #[serde(rename = "MQTT_MESSAGE_DISCONNECT")]
    Disconnect,
    #[serde(rename = "MQTT_MESSAGE_AUTH")]
    Auth,
}
