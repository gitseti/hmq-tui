...
/// ClientSubscription : List of result items that are returned by this endpoint
...
pub struct ClientSubscription {
    ...
    #[serde(rename = "retainAsPublished", skip_serializing_if = "Option::is_none")]
    pub retain_as_published: Option<bool>,
    /// Retain handling option
    #[serde(rename = "retainHandling", skip_serializing_if = "Option::is_none")]
    pub retain_handling: Option<RetainHandling>,
    /// The subscription identifier
    #[serde(rename = "subscriptionIdentifier", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub subscription_identifier: Option<Option<i32>>,
    /// The MQTT topic filter
    #[serde(rename = "topicFilter", skip_serializing_if = "Option::is_none")]
    pub topic_filter: Option<String>,
}

impl ClientSubscription {
    /// List of result items that are returned by this endpoint
    pub fn new() -> ClientSubscription {
        ClientSubscription {
            no_local: None,
            qos: None,
...
pub enum RetainHandling {
    #[serde(rename = "SEND")]
    Send,
    #[serde(rename = "SEND_IF_NEW_SUBSCRIPTION")]
