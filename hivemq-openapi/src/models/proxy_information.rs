...
/// ProxyInformation : Proxy Protocol information
...
pub struct ProxyInformation {
    ...
    #[serde(rename = "tlvs", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tlvs: Option<Option<Vec<crate::models::Tlv>>>,
}

impl ProxyInformation {
    /// Proxy Protocol information
    pub fn new() -> ProxyInformation {
        ProxyInformation {
            destination_ip: None,
