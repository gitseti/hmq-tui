...
/// ClientRestrictions : The restrictions that are in effect for this client
...
pub struct ClientRestrictions {
    ...
    #[serde(rename = "maxMessageSize", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub max_message_size: Option<Option<i64>>,
    /// maximum queue size
    #[serde(rename = "maxQueueSize", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub max_queue_size: Option<Option<i64>>,
    /// The queue strategy if the queue is full
    #[serde(rename = "queuedMessageStrategy", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub queued_message_strategy: Option<Option<String>>,
}

impl ClientRestrictions {
    /// The restrictions that are in effect for this client
    pub fn new() -> ClientRestrictions {
        ClientRestrictions {
            max_message_size: None,
            max_queue_size: None,
            queued_message_strategy: None,
        }
    }
}
