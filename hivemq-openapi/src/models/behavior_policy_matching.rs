...
/// BehaviorPolicyMatching : The matching rules the policy applies.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BehaviorPolicyMatching {
    /// The regex pattern to match the client id against.
    #[serde(rename = "clientIdRegex")]
    pub client_id_regex: String,
}

impl BehaviorPolicyMatching {
    /// The matching rules the policy applies.
    pub fn new(client_id_regex: String) -> BehaviorPolicyMatching {
