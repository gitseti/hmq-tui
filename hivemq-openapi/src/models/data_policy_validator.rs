...
/// DataPolicyValidator : A policy validator which executes the defined validation.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DataPolicyValidator {
...
impl DataPolicyValidator {
    /// A policy validator which executes the defined validation.
    pub fn new(arguments: serde_json::Value, r#type: String) -> DataPolicyValidator {
        DataPolicyValidator {
            arguments,
            r#type,
        }
