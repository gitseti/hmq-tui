...
/// DataPolicyValidation : The section of the policy that defines how incoming MQTT messages are validated. If this section is empty, the result of the policy validation is always successful.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DataPolicyValidation {
    /// The validators of the policy.
    #[serde(rename = "validators", skip_serializing_if = "Option::is_none")]
    pub validators: Option<Vec<crate::models::DataPolicyValidator>>,
}

impl DataPolicyValidation {
    ...
    pub fn new() -> DataPolicyValidation {
