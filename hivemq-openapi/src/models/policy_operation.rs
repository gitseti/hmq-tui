...
/// PolicyOperation : The pipeline to execute when this action is triggered. The operations in the pipeline are executed in order.
...
impl PolicyOperation {
    ...
    pub fn new(arguments: serde_json::Value, function_id: String, id: String) -> PolicyOperation {
        PolicyOperation {
            arguments,
            function_id,
            id,
