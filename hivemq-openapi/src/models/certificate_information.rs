...
/// CertificateInformation : The client certificate sent by the client
...
pub struct CertificateInformation {
    /// Common name
    #[serde(rename = "commonName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub common_name: Option<Option<String>>,
    /// Country
    ...
    /// Organizational unit
    #[serde(rename = "organizationalUnit", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub organizational_unit: Option<Option<String>>,
