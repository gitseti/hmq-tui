...
/// BehaviorPolicyBehavior : The behavior referenced by the policy, that is validated by the policy.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BehaviorPolicyBehavior {
...
impl BehaviorPolicyBehavior {
    /// The behavior referenced by the policy, that is validated by the policy.
    pub fn new(id: String) -> BehaviorPolicyBehavior {
