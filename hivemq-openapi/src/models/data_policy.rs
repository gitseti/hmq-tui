...
/// DataPolicy : A data policy which is used to validate and execute certain actions based on the validation result.
...
pub struct DataPolicy {
    ...
    pub matching: Box<crate::models::DataPolicyMatching>,
    #[serde(rename = "onFailure", skip_serializing_if = "Option::is_none")]
    pub on_failure: Option<Box<crate::models::DataPolicyAction>>,
    #[serde(rename = "onSuccess", skip_serializing_if = "Option::is_none")]
    pub on_success: Option<Box<crate::models::DataPolicyAction>>,
    #[serde(rename = "validation", skip_serializing_if = "Option::is_none")]
    pub validation: Option<Box<crate::models::DataPolicyValidation>>,
}

impl DataPolicy {
    /// A data policy which is used to validate and execute certain actions based on the validation result.
    pub fn new(id: String, matching: crate::models::DataPolicyMatching) -> DataPolicy {
        DataPolicy {
            created_at: None,
            id,
