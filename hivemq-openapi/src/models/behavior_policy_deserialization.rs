...
/// BehaviorPolicyDeserialization : The deserializers used by the policy for particular message and/or payload types.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BehaviorPolicyDeserialization {
    #[serde(rename = "publish", skip_serializing_if = "Option::is_none")]
    pub publish: Option<Box<crate::models::BehaviorPolicyDeserializer>>,
    #[serde(rename = "will", skip_serializing_if = "Option::is_none")]
    pub will: Option<Box<crate::models::BehaviorPolicyDeserializer>>,
}

impl BehaviorPolicyDeserialization {
    /// The deserializers used by the policy for particular message and/or payload types.
    pub fn new() -> BehaviorPolicyDeserialization {
