...
/// BehaviorPolicyDeserializer : The deserializer applied to a particular message or payload type.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BehaviorPolicyDeserializer {
    #[serde(rename = "schema")]
    pub schema: Box<crate::models::SchemaReference>,
}

impl BehaviorPolicyDeserializer {
    /// The deserializer applied to a particular message or payload type.
    pub fn new(schema: crate::models::SchemaReference) -> BehaviorPolicyDeserializer {
