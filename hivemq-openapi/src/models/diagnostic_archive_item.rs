...
pub struct DiagnosticArchiveItem {
    #[serde(rename = "diagnosticArchive", skip_serializing_if = "Option::is_none")]
    pub diagnostic_archive: Option<Box<crate::models::DiagnosticArchive>>,
}

impl DiagnosticArchiveItem {
    pub fn new() -> DiagnosticArchiveItem {
