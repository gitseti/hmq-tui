...
/// TlsInformation : TLS information



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TlsInformation {
    #[serde(rename = "certificateInformation", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub certificate_information: Option<Option<Box<crate::models::CertificateInformation>>>,
