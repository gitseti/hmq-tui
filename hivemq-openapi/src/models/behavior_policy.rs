...
/// BehaviorPolicy : A policy which is used to validate and execute certain actions based on the validation result.
...
pub struct BehaviorPolicy {
    ...
    pub behavior: Box<crate::models::BehaviorPolicyBehavior>,
    /// The formatted UTC timestamp indicating when the policy was created.
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "deserialization", skip_serializing_if = "Option::is_none")]
    pub deserialization: Option<Box<crate::models::BehaviorPolicyDeserialization>>,
    ...
    pub matching: Box<crate::models::BehaviorPolicyMatching>,
    #[serde(rename = "onTransitions", skip_serializing_if = "Option::is_none")]
    pub on_transitions: Option<Vec<crate::models::BehaviorPolicyOnTransition>>,
}

impl BehaviorPolicy {
    /// A policy which is used to validate and execute certain actions based on the validation result.
    pub fn new(behavior: crate::models::BehaviorPolicyBehavior, id: String, matching: crate::models::BehaviorPolicyMatching) -> BehaviorPolicy {
        BehaviorPolicy {
