...
/// BehaviorPolicyOnEvent : One or more operations that are triggered on the event. When this field is empty, the transition does not trigger any operations.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BehaviorPolicyOnEvent {
    #[serde(rename = "pipeline")]
    pub pipeline: Vec<crate::models::PolicyOperation>,
}

impl BehaviorPolicyOnEvent {
    ...
    pub fn new(pipeline: Vec<crate::models::PolicyOperation>) -> BehaviorPolicyOnEvent {
