...
pub struct FsmStatesInformationListItem {
    /// List of result items that are returned by this endpoint
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<crate::models::FsmStateInformationItem>>,
}

impl FsmStatesInformationListItem {
    pub fn new() -> FsmStatesInformationListItem {
