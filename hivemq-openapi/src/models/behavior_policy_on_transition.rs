...
/// BehaviorPolicyOnTransition : The actions that are executed for the specified transition.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BehaviorPolicyOnTransition {
    #[serde(rename = "Connection.OnDisconnect", skip_serializing_if = "Option::is_none")]
    pub connection_period_on_disconnect: Option<Box<crate::models::BehaviorPolicyOnEvent>>,
    #[serde(rename = "Event.OnAny", skip_serializing_if = "Option::is_none")]
    pub event_period_on_any: Option<Box<crate::models::BehaviorPolicyOnEvent>>,
    #[serde(rename = "Mqtt.OnInboundConnect", skip_serializing_if = "Option::is_none")]
    pub mqtt_period_on_inbound_connect: Option<Box<crate::models::BehaviorPolicyOnEvent>>,
    #[serde(rename = "Mqtt.OnInboundDisconnect", skip_serializing_if = "Option::is_none")]
    pub mqtt_period_on_inbound_disconnect: Option<Box<crate::models::BehaviorPolicyOnEvent>>,
    #[serde(rename = "Mqtt.OnInboundPublish", skip_serializing_if = "Option::is_none")]
    pub mqtt_period_on_inbound_publish: Option<Box<crate::models::BehaviorPolicyOnEvent>>,
    #[serde(rename = "Mqtt.OnInboundSubscribe", skip_serializing_if = "Option::is_none")]
    pub mqtt_period_on_inbound_subscribe: Option<Box<crate::models::BehaviorPolicyOnEvent>>,
...
impl BehaviorPolicyOnTransition {
    /// The actions that are executed for the specified transition.
    pub fn new(from_state: String, to_state: String) -> BehaviorPolicyOnTransition {
        BehaviorPolicyOnTransition {
            connection_period_on_disconnect: None,
            event_period_on_any: None,
            mqtt_period_on_inbound_connect: None,
            mqtt_period_on_inbound_disconnect: None,
            mqtt_period_on_inbound_publish: None,
            mqtt_period_on_inbound_subscribe: None,
            from_state,
            to_state,
        }
    }
