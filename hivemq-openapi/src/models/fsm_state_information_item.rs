...
/// FsmStateInformationItem : List of result items that are returned by this endpoint



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FsmStateInformationItem {
    /// The arguments of the fsm derived from the behavior policy.
    #[serde(rename = "arguments", skip_serializing_if = "Option::is_none")]
    pub arguments: Option<serde_json::Value>,
    /// The unique identifier of the policy.
    #[serde(rename = "behaviorId", skip_serializing_if = "Option::is_none")]
    pub behavior_id: Option<String>,
    /// The timestamp when this state was set the first time.
    #[serde(rename = "firstSetAt", skip_serializing_if = "Option::is_none")]
    pub first_set_at: Option<String>,
    /// The unique identifier of the policy.
...
impl FsmStateInformationItem {
    /// List of result items that are returned by this endpoint
    pub fn new() -> FsmStateInformationItem {
