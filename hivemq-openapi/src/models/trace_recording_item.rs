...
pub struct TraceRecordingItem {
    #[serde(rename = "traceRecording")]
    pub trace_recording: Box<crate::models::TraceRecording>,
}

impl TraceRecordingItem {
    pub fn new(trace_recording: crate::models::TraceRecording) -> TraceRecordingItem {
        TraceRecordingItem {
            trace_recording: Box::new(trace_recording),
        }
    }
}
