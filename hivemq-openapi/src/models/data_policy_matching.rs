...
/// DataPolicyMatching : The matching rules the policy applies.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DataPolicyMatching {
    /// The topic filter for which the policy is matched.
    #[serde(rename = "topicFilter")]
    pub topic_filter: String,
}

impl DataPolicyMatching {
    /// The matching rules the policy applies.
    pub fn new(topic_filter: String) -> DataPolicyMatching {
        DataPolicyMatching {
            topic_filter,
        }
    }
