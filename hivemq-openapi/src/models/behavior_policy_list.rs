...
/// BehaviorPolicyList : A listing of behavior policies.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BehaviorPolicyList {
    ...
    pub items: Option<Vec<crate::models::BehaviorPolicy>>,
}

impl BehaviorPolicyList {
    /// A listing of behavior policies.
    pub fn new() -> BehaviorPolicyList {
        BehaviorPolicyList {
            _links: None,
            items: None,
        }
